...
Foam::scalar Foam::decayingTurbulenceFvPatchVectorField::t() const
{
...
void Foam::decayingTurbulenceFvPatchVectorField::reset
(
    const fvPatchVectorField& ptf
)
{
    ...
    LField_.reset(tiptf.LField_);
    refField_.reset(tiptf.refField_);
    RField_.reset(tiptf.RField_);
    R_.reset(tiptf.R_);
    nVortField_.reset(tiptf.nVortField_);
}
...
void Foam::decayingTurbulenceFvPatchVectorField::write
(
    Ostream& os
) const
{
